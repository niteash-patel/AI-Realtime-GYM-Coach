...
def main():
    ...
    load_css(os.path.join(os.getcwd(), "static", "style.css")) #cwd=current working directory
    ...
    with st.sidebar:
        ...
        if not workout_started:
            ...
            if start_session_button:
                ...
                st.session_state.last_modifide_sets_complited=0
                st.session_state.last_modifide_workout_compleated=0
                st.rerun()
            ...
            ends_session_button=st.button("end workout", width="stretch", key="ends_workout_button")

            if ends_session_button:
